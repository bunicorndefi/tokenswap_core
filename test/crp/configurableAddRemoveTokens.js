...
contract('configurableAddRemoveTokens', async (accounts) => {
    ...
    it('Controller should be able to commitAddToken', async () => {
        ...
        const bPool = await BPool.at(kPoolAddr);
        const kPoolAbcBalance = await abc.balanceOf.call(kPoolAddr);
        ...
        assert.equal(kPoolAbcBalance, toWei('0'));
    ...
    it('Controller should be able to applyAddToken', async () => {
        ...
        let kPoolAbcBalance = await abc.balanceOf.call(kPoolAddr);
        ...
        kPoolAbcBalance = await abc.balanceOf.call(kPoolAddr);
        ...
        assert.equal(kPoolAbcBalance, toWei('10000'));
    ...
    it('Controller should be able to removeToken if token is bound', async () => {
        ...
        let kPoolAbcBalance = await abc.balanceOf.call(kPoolAddr);
        let kPoolXYZBalance = await xyz.balanceOf.call(kPoolAddr);
        let kPoolWethBalance = await weth.balanceOf.call(kPoolAddr);
        let kPoolDaiBalance = await dai.balanceOf.call(kPoolAddr);
        ...
        assert.equal(kPoolXYZBalance, toWei('80000'));
        assert.equal(kPoolWethBalance, toWei('40'));
        assert.equal(kPoolDaiBalance, toWei('0'));
